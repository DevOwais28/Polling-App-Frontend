        ...
        <CardContent>
          <form onSubmit={handleJoinPoll} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="privateKey" className="text-sm font-medium">Private Access Key</Label>
              <Input
                id="privateKey"
                type="text"
            ...
            <Button type="submit" className="w-full" disabled={isLoading || !privateKey.trim()}>
              {isLoading ? "Joining..." : <>Join Private Poll <ArrowRight className="ml-2 h-4 w-4" /></>}
            </Button>
          </form>

          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">Don't have an access key?</p>
            <Button
              variant="link"
